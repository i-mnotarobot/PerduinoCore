...
And best of all, PerduinoCore is supported!
...
## PerduinoCore + PlatformIO
PerduinoCore and PlatformIO goes great together. You can do serial uploads and upload using a dedicated programmer, but you can also let PlatformIO calulate the fuses and load the correct bootloader file, just like Arduino IDE does!
...
You can find a platformio.ini template you can use when creating a project for a PerduinoCore compatible device below.  
...
``` ini
; PlatformIO Project Configuration File for PerduinoCore
; https://github.com/MCUdude/PerduinoCore/
;
...
; https://github.com/MCUdude/PerduinoCore/blob/master/PlatformIO.md
...
Below is a table with supported clocks for PerduinoCore. Defaults to 16 MHz if not specified.
